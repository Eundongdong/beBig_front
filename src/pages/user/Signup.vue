    ...
    <div class="Page">
        ...
        <div class="Input1">
            <ul>
                ...
                <li>
                    <h3>아이디</h3>
                    <input type="text" v-model="User.userId" placeholder="Enter your ID" @change="idDupCheckAPI"/>
        ...
        <div class="Input2">
            <ul>
                <li>
                    <h3>닉네임</h3>
                    <input type="text" v-model="User.nickname" placeholder="Enter your NickName"/>
                </li>
                <li>
                    <h3>이메일</h3>
                    <input type="text" v-model="User.email" placeholder="Enter your Email"/>
                </li>
                <li>
                    <h3>성별</h3>
                    <label>
        ...
        <div class="Policy">
            ...
            <ul>
                <li>
                    ...
                    <button @click="toggleShowPersonalTerms">{{ showPersonalTerms ? '▲' : '▼' }}</button>
            ...
            <ul>
                <li>
                    ...
                    <button @click="toggleShowFinancialTerms">{{ showFinancialTerms ? '▲' : '▼' }}</button>
        ...
        <div class="Button">
            <button class="signup_button" @click="signup" :disabled="!allAgree">가입하기</button>
        </div>
    </div>
</template>
