...
const testUserApi = async () => {
  try {
    ...
    // 7. 아이디 찾기 테스트
    const findloginUserId = {
      name: '이름',
      email: '이메일',
    };
    const foundloginUserId = await UserApi.findloginUserId(findloginUserId);
    console.log('아이디 찾기 성공:', foundloginUserId);
